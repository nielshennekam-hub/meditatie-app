...
- **Eigen klankschaal** — neem je eigen klankschaal op met de microfoon (of kies een audiobestand); de opname wordt lokaal bewaard en klinkt bij start, interval en einde
